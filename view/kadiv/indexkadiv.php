            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                     ...
                     <li>
                        <a c href="<?php echo URL; ?>proker"><i class="fa fa-file-text"></i> Program Kerja</a>
                    </li>
                    <li>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-12 col-xs-12">
                        <div class="panel panel-primary text-center no-boder bg-color-green green">
                            ...
                            <div class="panel-right">
								<h3><?php echo $this->hasilk['proker']; ?> </h3>
                    ...
                    <div class="col-md-3 col-sm-12 col-xs-12">
                        <div class="panel panel-primary text-center no-boder bg-color-blue">
                            ...
                            <div class="panel-right">
							<h3><?php echo $this->hasilk['evaluasi']; ?> </h3>
                    ...
                    <div class="col-md-3 col-sm-12 col-xs-12">
                        <div class="panel panel-primary text-center no-boder bg-color-red">
                            ...
                            <div class="panel-right">
							 <h3><?php echo $this->hasilk['lpjbelom']; ?> </h3>
                               <strong> LPJ BELUM DIINPUTKAN </strong>
