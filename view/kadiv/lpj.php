                                ...
                                <div class="container-fluid" style="margin-top:20px;">
                                    <form class="form-horizontal" role="form">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-7">
                                                <div class="inner-addon left-addon"> 
                                                    <input type="text" class="form-control" value="<?php echo $this->namaproker; ?>" readonly>
                                                </div>
                                            </div>
                                        </div>
                                       ...
                                       <!--Pendahuluan-->
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-7">
                                                <div class="inner-addon left-addon"> 
                                                     <textarea type="text" rows="9" class="form-control" placeholder="Latar Belakang" name="latarbelakang" required></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-7">
                                                <div class="inner-addon left-addon"> 
                                                     <textarea type="text" rows="9" class="form-control" placeholder="Rasional kegiatan" name="rasional" required></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-7">
                                                <div class="inner-addon left-addon"> 
                                                    <textarea type="text" rows="9" class="form-control" placeholder="Tujuan" name="tujuan" required></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-7">
                                                <div class="inner-addon left-addon"> 
                                                    <input type="text" class="form-control" name="tempatkegiatan" placeholder="Tempat Kegiatan" required>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-7">
                                                <div class="inner-addon left-addon"> 
                                                     <textarea type="text" class="form-control" placeholder="Peserta" data-toggle="tooltip" data-placement="left" title="Tuliskan Berapa dan Sasarannya Siapa" name="peserta" required></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-7 col-sm-6 col-xs-12 spas">
                                                <select class="form-control col-md-6 col-sm-6 col-xs-12" name="sesuai" required>
                                       ...
                                       <div class="form-group">
                                            ...
                                            <div class="col-sm-7">
                                                <div class="inner-addon left-addon"> 
                                                     <textarea type="text" rows="9" class="form-control" placeholder="Kendala" name="kendala" required></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-7">
                                                <div class="inner-addon left-addon"> 
                                                     <textarea type="text" rows="9" class="form-control" placeholder="Solusi" name="solusi" required></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <button class="btn btn-warning col-md-4" type="submit" name="hitung" style="margin-left: 25%; margin-bottom: 20px;">Selesai</button>
                                    </form>
                                </div>
                            </div>
                        </div>
